...
class Dataset(torch.utils.data.Dataset):
    def __init__(self, transform, mode):
        ...
        if self.mode == 'train':
            ...
            set = 'evaluation'
        self.annot_path = osp.join(self.root_path, 'interhand_hanco_dex_ho3d_' + set + '.json')
        ...
        for aid in db.anns.keys():
            ...
            img_path = osp.join(img['file_name'])
            ...
            data = {'img_path': img_path, 'bbox': bbox, 'cam_param': cam_param, 'joint': joint, 'hand_type': ann["hand_type"], 'abs_depth': abs_depth}
    ...
    def evaluate(self, preds):
        ...
        for n in range(sample_num):
            ...
            pred_joint_coord_img[:,2][self.joint_type['right']] = \
                pred_joint_coord_img[:,2][self.joint_type['right']] + data['abs_depth']['right']
            pred_joint_coord_img[:,2][self.joint_type['left']] = \
                pred_joint_coord_img[:,2][self.joint_type['left']] + data['abs_depth']['left']
